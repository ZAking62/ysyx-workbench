...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 100 ????? 00000 11", lbu    , I, R(rd) = Mr(src1 + imm, 1));
	...
	INSTPAT("0100000 ????? ????? 101 ????? 00100 11", srai	 , I, R(rd) = src1 >> imm);//1
	INSTPAT("0000000 ????? ????? 011 ????? 01100 11", sltu	 , R, R(rd) = src1 < src2);
	INSTPAT("0000000 ????? ????? 010 ????? 01100 11", slt		 , R, R(rd) = (int)src1 < (int)src2);
	INSTPAT("0000000 ????? ????? 000 ????? 01100 11", add		 , R, R(rd) = src1 + src2);
	INSTPAT("0100000 ????? ????? 000 ????? 01100 11", sub		 , R, R(rd) = src1 - src2);
	INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div		 , R, R(rd) = (int)src1 / (int)src2);//1
	INSTPAT("0000001 ????? ????? 101 ????? 01100 11", divu	 , R, R(rd) = src1 / src2);//1
	INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem		 , R, R(rd) = (int)src1 % (int)src2);//1
	INSTPAT("0000001 ????? ????? 111 ????? 01100 11", remu	 , R, R(rd) = src1 % src2);//1
