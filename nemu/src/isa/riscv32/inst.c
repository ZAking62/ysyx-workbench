...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 100 ????? 00000 11", lbu    , I, R(rd) = Mr(src1 + imm, 1));
	...
	INSTPAT("0000000 ????? ????? 101 ????? 01100 11", srl		 , R, R(rd) = src1 >> src2);//1
	INSTPAT("0000000 ????? ????? 101 ????? 00100 11", srli	 , I, R(rd) = src1 >> imm);//1
  ...
  INSTPAT("0000000 ????? ????? 100 ????? 00100 11", xori	 , I, R(rd) = src1 ^ imm);
